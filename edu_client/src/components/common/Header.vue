    ...
    <div class="header-box">
        <div class="header">
            <div class="content">
                ...
                <ul class="nav full-left" style="padding-left: 220px">
                    <li v-for="(v,i) in footer_list" :key="i">
                        <a :href="v.link" v-if="v.is_site">{{ v.title }}</a>
                        <router-link v-else-if="!v.is_site" :to="v.link">{{ v.title }}</router-link>
                    </li>
                ...
                <div class="login-bar full-right" v-if="token">
                    ...
                    <div class="login-box full-left">
                        ...
                        &nbsp;|&nbsp;
                        <span @click="del_session">退出登录</span>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        get_all() {
            this.axios({
                url: this.$settings.HOST + 'home/footer1/',
                method: 'get',
            }).then(res => {
                console.log(res);
