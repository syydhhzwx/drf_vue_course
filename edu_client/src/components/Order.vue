        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in course_list" :key="course.id">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price" >{{course.discount_name}}</el-col>
                    <el-col :span="4" class="course-price" v-if="course.discount_name">¥{{course.real_price}}</el-col>
                    <el-col :span="4" class="course-price" v-else>¥{{course.price}}</el-col>
                </el-row>
            </div>
            <div class="calc">
